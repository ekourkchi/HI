...
if __name__ == '__main__':
  ...
  repository = '/home/ehsan/db_esn/SDSS_AddFinale/' 
  ...
  p=0
  #while p<len(id_) and int(id_lexi[p][3:10]) != 91783: p+=1
  
  
  for j in range(p, len(id_)):
    ...
    if pgc_lexi in pgc: 
      ...
      if sdss_[j]==1 and not os.path.isdir(repository+'pgc'+str(pgc[i])) and not pgc_lexi in pgc2:
