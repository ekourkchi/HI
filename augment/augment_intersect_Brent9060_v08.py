...
def getINC():
    ...
    #### Manoa
    inFile = 'EDD.inclination.All.Manoa.13Apr2018120001.txt'
    table = np.genfromtxt(inFile , delimiter='|', filling_values=None, names=True, dtype=None)
    ...
    #### Guest
    inFile = 'EDD.inclination.All.Guest.13Apr2018120108.txt'
    table = np.genfromtxt(inFile , delimiter='|', filling_values=None, names=True, dtype=None)
...
myTable.write('EDD_distance_cf4_v18.csv', format='ascii.fixed_width',delimiter='|', bookend=False, overwrite=True) 
