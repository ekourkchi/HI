...
def getINC(include_Email=None, exclude_Email=[]):
    ...
    #### Manoa
    inFile = 'EDD.inclination.All.Manoa.11Jul2019221853.txt'
    table = np.genfromtxt(inFile , delimiter='|', filling_values=None, names=True, dtype=None)
    ...
    #### Guest
    inFile = 'EDD.inclination.All.Guest.11Jul2019221834.txt'
    table = np.genfromtxt(inFile , delimiter='|', filling_values=None, names=True, dtype=None)
...
myTable.write('EDD_distance_cf4_v27.csv', format='ascii.fixed_width',delimiter='|', bookend=False, overwrite=True) 
