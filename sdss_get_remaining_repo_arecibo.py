...
if __name__ == '__main__':
  ...
  repository = '/home/ehsan/db_esn/SDSS_Additional2/' 
  
  
  inFile  = 'augment/EDD_distance_cf4_v09.csv'
...
###############################
  ...
  inFile = 'augment/All_LEDA_EDD.csv'
  table = np.genfromtxt( inFile , delimiter=',', filling_values=None, names=True, dtype=None)
  pgc_leda    = table['pgc']
...
##################################################  
  ...
  ii = 0
  while ii<len(pgc_TFcalibrators):
      if pgc_TFcalibrators[ii]==1627904: break
      ii+=1
      

  for i in range(ii, len(pgc_TFcalibrators)):
