...
with open('html_tables/all_brent_9060.html', 'w+') as f:
 ...
 <h2 id="all.brent.9060">All 9060 galaxies ... (Brent's catalog)</h2>
...
"""
  ...
  S  = open("html_db/all_brent_9060.tbl.html","rb").read()
  f.write(S+"\n")
