...
if __name__=='__main__':
    ...
    pgcname, radb = read_glga('cf4_wise_all.glga')
    ...
    for i in range(len(pgcname)):
        ...
        for filter in ['w1','w2','w3','w4']:
            ...
            if os.path.exists(fname):
                ...
                fname2 = databse+radb[i]+'/wise/fits/'+pgcname[i]+'_'+filter+'.fits'
            ...
            if os.path.exists(fname):
                ...
                fname2 = databse+radb[i]+'/wise/fits/'+pgcname[i]+'_'+filter+'_unc.fits'
                if os.path.exists(fname2):
                    command = ["rm", fname2]
                    print command
                    subprocess.call(command)
