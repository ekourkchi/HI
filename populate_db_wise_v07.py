...
destination = '/home/ehsan/Home/wise_photometry/'
        ...
        for i in range(len(pgc)):
            ...
            if os.path.exists(qa_txt):
                    ...
                    with cd(directory):
                        ...
                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w1.jpg .'
                        xcmd(cmd, True)
                        
                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w2.jpg .'
                        xcmd(cmd, True)
                        ...
                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w1.pdf .'
                        xcmd(cmd, True)

                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w2.pdf .'
                        xcmd(cmd, True)
                                                

                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w1.scales.pdf .'
                        xcmd(cmd, True)

                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w2.scales.pdf .'
                        xcmd(cmd, True)
                        
                        
                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w1.scales.jpg .'
                        xcmd(cmd, True)

                        cmd = 'cp '+ location + radb + '/plots/' + galname + '_w2.scales.jpg .'
                        xcmd(cmd, True)                        

                        cmd = 'cp '+ location + radb + '/photometry/' + galname + '_w1.scales.dat .'
                        xcmd(cmd, True)

                        cmd = 'cp '+ location + radb + '/photometry/' + galname + '_w2.scales.dat .'
                        xcmd(cmd, True)   
                        
                        cmd = 'cp '+ location + radb + '/photometry/' + galname + '_*_annprofile.dat .'
                        xcmd(cmd, True)

                        cmd = 'cp '+ location + radb + '/photometry/' + galname + '_*_totprofile.dat .'
                        xcmd(cmd, True)                        
