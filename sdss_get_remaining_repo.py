...
if __name__ == '__main__':
  ...
  repository = '/home/ehsan/db_esn/REMAINDER_SDSS/'  
  ...
  N = len(pgc)
  j = 3
  ###  pgc9573  was the galaxy when the crash happened
  while pgc[j] != 9573  and j<N: j+=1
   
  count = 0 
  for i in range(j,N):
     
     if sdss[i] == 1 and not pgc[i] in pgc_alfalfa and SDSS_db_avilability(pgc[i], ra[i], dec[i], Filters=['g','r','i']) < 3:
