            ...
            if os.path.exists(qa_txt):
                ...
                with cd(directory):
                    ...
                    for filter in ['u','g','r','i','z']:
                       ...
                       cmd = 'cp '+ location + radb + '/plots/' + galname + '_'+filter+'.scales.jpg .'
                       xcmd(cmd, True)
            
                       cmd = 'cp '+ location + radb + '/plots/' + galname + '_'+filter+'.scales.pdf .'
                       xcmd(cmd, True) 

                       cmd = 'cp '+ location + radb + '/photometry/' + galname + '_'+filter+'.scales.dat .'
                       xcmd(cmd, True) 
