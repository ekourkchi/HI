...
for i in range(N):
  ...
  for p in range(5):
	...
	for line in f:
     ...
     #s += "_sdss_profile.jpg profile]  ||  [http://www.ifa.hawaii.edu/~ehsan/test/" + pgc_id
...
ax.set_xlabel('z-mag (Neil)', fontsize=14)

ax.set_ylabel(r'$\Delta$'+'z (Neil-Ehan)', fontsize=14)



lit =  zz[0:N]
ehsan =  mags[0:N,4]
ax.plot(lit, lit-ehsan, 'o', color='brown', markersize=4, picker=5)
